...
/**
 * Resumen ejecutivo para el dashboard de PRESIDENCIA.
 *
 * Calcula los agregados server-side (sin paginación) para que los KPIs del
 * dashboard sean exactos aunque haya más obras de las que caben en la
 * primera página de GET /projects. Único punto de agregación del módulo.
 */
