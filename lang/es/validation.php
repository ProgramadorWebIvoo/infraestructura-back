...
/**
 * Mensajes de validación en español. Locale de la app cambiado de 'en' a
 * 'es' (config/app.php) — hasta ahora TODO mensaje de validación de Laravel
 * que llegaba al usuario sin un chequeo previo en el frontend (ej. RIF
 * duplicado, solo detectable contra el servidor) salía en inglés ("The rif
 * has been taken."). fallback_locale sigue en 'en', así que cualquier clave
 * que falte acá cae de vuelta al inglés en vez de romper.
 */
...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traduce el placeholder :attribute a un nombre legible en español —
    | sin esto, "El campo rif es obligatorio" queda bien porque coincide
    | con el nombre real de la columna, pero campos con nombre técnico se
    | verían crudos (ej. "selectedProposalId").
    |
    */
    'attributes' => [
        'name' => 'nombre',
