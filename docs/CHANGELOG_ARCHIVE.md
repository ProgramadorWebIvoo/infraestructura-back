# CHANGELOG — Archivo histórico

Entradas del 2026-07-31 hacia atrás, movidas fuera de `CHANGELOG.md` para mantenerlo escaneable. El registro más reciente vive en `/CHANGELOG.md` (raíz del repo).
